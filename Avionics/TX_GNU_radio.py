...
class TX_GNU_radio(gr.top_block):
    ...
    def __init__(self):
        ...
        self.network_udp_source_0 = network.udp_source(gr.sizeof_char, 1, 9000, 0, 188, True, False, False)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_char, 1, 188, "packet_len")
